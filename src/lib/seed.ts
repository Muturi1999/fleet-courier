...
import { calcWorkTicketAmounts, emptyVehicleCondition, referenceWorkTicket1189100 } from "./work-ticket-meta";
...
export function buildSeedData(): FleetData {
  ...
  const workTickets: WorkTicket[] = [
    { ...referenceWorkTicket1189100(nid("wt")) },
    {
      id: nid("wt"),
      serialNo: "1189105",
      branch: "Embakasi",
    ...
    },
    {
      ...
      legs: [{ id: nid("leg"), details: "Nairobi — Nakuru", openingMileage: 100100, timeOut: "0600", officerAuthorising: "", fuelDrawn: "", timeIn: "1400", closingMileage: 100380, journeyType: "A/V", serviceDone: "", officerConfirming: "" }],
      privateKm: 0,
      officialKm: 280,
      ...wtFormExtras,
      ...calcWorkTicketAmounts(14000),
    ...
    },
    {
      ...
      legs: [{ id: nid("leg"), details: "CBD collection", openingMileage: 200100, timeOut: "0800", officerAuthorising: "", fuelDrawn: "", timeIn: "1700", closingMileage: 200165, journeyType: "S/S", serviceDone: "", officerConfirming: "" }],
      privateKm: 0,
      officialKm: 65,
      ...wtFormExtras,
    ...
    },
    {
      ...
      legs: [{ id: nid("leg"), details: "Nairobi — Kisumu", openingMileage: 100380, timeOut: "0500", officerAuthorising: "", fuelDrawn: "", timeIn: "1800", closingMileage: 100720, journeyType: "A/V", serviceDone: "", officerConfirming: "" }],
      privateKm: 0,
      officialKm: 340,
      ...wtFormExtras,
