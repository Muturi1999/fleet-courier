    ...
    <div className="delivery-hero" aria-hidden>
      <div className="delivery-hero-map">
        <svg viewBox="0 0 400 280" className="h-full w-full" fill="none">
          ...
          <text x="28" y="220" fill="rgba(255,255,255,0.35)" fontSize="10">Nairobi</text>
          <text x="310" y="70" fill="rgba(255,255,255,0.35)" fontSize="10">Upcountry</text>
        </svg>

        <div className="delivery-hero-truck delivery-hero-truck-1">
          <IconTruckDelivery size={28} className="text-accent" />
        </div>
        <div className="delivery-hero-truck delivery-hero-truck-2">
          <IconTruckDelivery size={22} className="text-teal opacity-80" />
        </div>
      </div>

      <div className="delivery-hero-cards">
        <div className="delivery-hero-card delivery-hero-card-float-1">
          <IconPackage size={18} className="text-accent" />
          <div>
            <p className="text-[10px] uppercase tracking-wider text-white/40">In transit</p>
            <p className="text-sm font-semibold text-white">Local deliveries</p>
          </div>
        </div>
        <div className="delivery-hero-card delivery-hero-card-float-2">
          <IconMapPin size={18} className="text-teal" />
          <div>
            <p className="text-[10px] uppercase tracking-wider text-white/40">Routes</p>
            <p className="text-sm font-semibold text-white">40+ destinations</p>
          </div>
        </div>
      </div>
    </div>
